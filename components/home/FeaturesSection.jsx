...
export default function FeaturesSection() {
    return (<section className="py-16 lg:py-24 bg-muted">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            return (<div key={feature.id} className="flex items-start gap-4">
                    <div className={`w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0 ${colorMap[feature.color]}`}>
          ...
          <div className="relative">
            <div className="aspect-[4/3] rounded-3xl overflow-hidden shadow-xl">
              <img src="/Rectangle.png?height=600&width=500" alt="Travel App" className="w-full h-full object-cover"/>
            </div>
          </div>
        </div>
      </div>
