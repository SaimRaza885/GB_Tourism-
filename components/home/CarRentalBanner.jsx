                ...
                <div className="relative overflow-hidden bg-linear-to-r from-muted to-muted/50 rounded-[2.5rem] border border-border p-8 md:p-12 group hover:shadow-2xl hover:shadow-primary/5 transition-all duration-500">
                    ...
                    <div className="relative flex flex-col md:flex-row items-center justify-between gap-8">
                        ...
                        <div className="shrink-0 w-full md:w-auto">
                            <Link href="/cars" className="w-full md:w-auto inline-flex items-center justify-center gap-2 bg-foreground text-background px-8 py-4 rounded-full font-bold text-lg hover:bg-primary hover:text-primary-foreground transition-all shadow-lg hover:shadow-primary/20 active:scale-95 group">
                                Book a Car
