...
export default function ServicesGrid() {
    return (<section className="py-12 relative z-20 -mt-16 md:-mt-24 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    {services.map((service, index) => (<Link key={index} href={service.href} className="group relative bg-card/80 backdrop-blur-xl border border-border p-6 rounded-4xl shadow-2xl hover:shadow-primary/20 transition-all duration-500 hover:-translate-y-2 overflow-hidden">
