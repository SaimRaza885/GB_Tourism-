      ...
      {/* Right Image */}
       <div className="relative">
            <div className="md:aspect-[3/3] aspect-auto rounded-3xl overflow-hidden ">
              <img src="/Group 6.png" alt="Gilgit City" className="w-full h-full object-cover"/>
            </div>
            {/* Decorative elements */}
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-6">
              {stats.map((stat, index) => (<div key={index} className="text-center p-6 bg-primary-light rounded-2xl">
