...
export default function BlogSection() {
    ...
    return (<section className="py-16 lg:py-24 bg-muted text-center md:text-left">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <SectionHeading badge="Latest News" title={<>Our Travel <span className="text-primary">Stories</span></>} linkHref="/blog" linkText="Read All Stories"/>

                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {latestPosts.map((post) => (<Link key={post.id} href={`/blog/${post.slug}`} className="group">
