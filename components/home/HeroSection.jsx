...
export default function HeroSection() {
    return (<section className="relative h-screen min-h-[700px] w-full flex items-center overflow-hidden bg-gray-900">
      {/* Cinematic Background */}
      <div className="absolute inset-0 z-0">
        <Image src="https://images.unsplash.com/photo-1551632811-561732d1e306?q=80&w=2070&auto=format&fit=crop" alt="Majestic Gilgit-Baltistan Expedition" width={1920} height={1080} priority className="w-full h-full object-cover object-center brightness-90"/>
        {/* Gradient Overlay */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="max-w-2xl space-y-6">
          ...
          <div className="pt-4 animate-in fade-in slide-in-from-left-12 duration-1000 delay-300">
            <Link href="/packages" className="group relative inline-flex items-center gap-3 px-10 py-5 bg-primary text-white rounded-full font-heading font-black text-xl hover:bg-white hover:text-primary transition-all shadow-2xl active:scale-95 overflow-hidden">
