...
export default function GuidesTeaser() {
    return (<section className="py-24 bg-foreground text-white overflow-hidden relative">
            {/* Background Glow */}
            <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-primary/20 rounded-full blur-[120px] -mr-64 -mt-64"/>

            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <SectionHeading badge="Local Legends" title={<>Meet Your <span className="text-primary italic">Expert Guides</span></>} description="Travel with certified local legends who know these mountains better than anyone else." linkHref="/guides" linkText="View All Guides"/>

                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                    {guides.slice(0, 4).map((guide) => (<div key={guide.id} className="group flex flex-col items-center">
