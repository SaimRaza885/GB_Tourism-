...
export default function PrivacyPage() {
    return (<main className="min-h-screen pb-20">
            <PageBanner height="50vh" badge="Security" badgeIcon={FaShieldAlt} title="Privacy Policy" image="https://images.unsplash.com/photo-1550751827-4bd374c3f58b?q=80&w=2070&auto=format&fit=crop" description="Effective Date: February 10, 2026"/>
