...
import { FaUsers, FaGasPump, FaCogs, FaShieldAlt, FaAward, FaCalendarAlt } from "react-icons/fa";
...
export default async function CarDetailsPage({ params }) {
    ...
    return (<main className="bg-background min-h-screen pb-20">
            ...
            <div className="relative h-[60vh] w-full overflow-hidden group">
                <Image src={car.image || "/placeholder.svg"} alt={car.name} className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" width={1200} height={800}/>
                        ...
                        <div className="sticky top-24 space-y-8">
                            ...
                            <div className="bg-card rounded-3xl p-6 border border-border shadow-lg">
                                ...
                                <div className="space-y-4">
                                    {similarCars.map((sc) => (<Link href={`/cars/${sc.id}`} key={sc.id} className="flex gap-3 group">
                                            <div className="w-20 h-16 rounded-lg overflow-hidden shrink-0 bg-muted">
                                                <Image src={sc.image} alt={sc.name} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" width={1200} height={800}/>
                                            </div>
