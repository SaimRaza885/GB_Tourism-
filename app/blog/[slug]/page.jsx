...
export default async function BlogPostPage({ params }) {
    ...
    return (<article className="min-h-screen bg-background pb-20">
            {/* Hero Section */}
            <div className="relative h-[60vh] min-h-[400px] w-full overflow-hidden">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-8 md:p-12 lg:p-16 max-w-7xl mx-auto w-full">
                    <Link href="/blog" className="inline-flex items-center gap-2 text-white/80 hover:text-white mb-6 transition-colors backdrop-blur-sm bg-black/20 px-4 py-2 rounded-full text-sm font-medium w-fit">
            ...
            prose-img:rounded-xl prose-img:shadow-lg" dangerouslySetInnerHTML={{ __html: post.content }}/>
            ...
            .slice(0, 3)
            .map(related => (<Link key={related.id} href={`/blog/${related.slug}`} className="group flex gap-4">
