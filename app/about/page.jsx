...
import { FaBullseye, FaEye, FaUsers, FaShieldAlt, FaMountain } from "react-icons/fa";
import Link from "next/link";
import PageBanner from "@/components/layout/PageBanner";
export default function AboutPage() {
    return (<main className="min-h-screen pb-20">
            <PageBanner height="50vh" badge="Our Agency" badgeIcon={FaMountain} title="Discover Our Story" image="https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?q=80&w=2070&auto=format&fit=crop" description="Connecting adventurous souls with the hidden gems of Gilgit-Baltistan since 2020."/>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="relative">
                        <div className="aspect-square rounded-[3rem] overflow-hidden shadow-2xl skew-y-2 hover:skew-y-0 transition-transform duration-700">
                            <img src="https://images.unsplash.com/photo-1549400813-982fe3929497?q=80&w=2070&auto=format&fit=crop" alt="Gilgit Landscape" className="w-full h-full object-cover"/>
                        </div>
            ...
            <section className="bg-muted/50 py-32 mb-32">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <SectionHeading center badge="Our Team" title={<>Meet Our <span className="text-primary italic">Expert Guides</span></>} description="The faces behind your adventures. Our guides are local experts with deep roots in the mountains."/>

                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {guides.map((guide) => (<div key={guide.id} className="group bg-card rounded-[2.5rem] overflow-hidden border border-border shadow-sm hover:shadow-2xl hover:border-primary/20 transition-all duration-500 hover:-translate-y-2">
                                ...
                                <div className="p-6">
                                    ...
                                    <Link href={`/guides/${guide.id}`} className="inline-flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-primary hover:gap-3 transition-all">
                                        View Profile
                                    </Link>
                                </div>
                            </div>))}
