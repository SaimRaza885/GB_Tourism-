...
export default function TermsPage() {
    return (<main className="min-h-screen pb-20">
            <PageBanner height="50vh" badge="Legal" badgeIcon={FaRegHandshake} title="Terms & Conditions" image="https://images.unsplash.com/photo-1450101499163-c8848c66ca85?q=80&w=2070&auto=format&fit=crop" description="Last Updated: February 10, 2026"/>
