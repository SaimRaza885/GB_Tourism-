...
export default function GuidesPage() {
    ...
    return (<main className="min-h-screen bg-background">
            <PageBanner height="50vh" badge="Certified Experts" badgeIcon={FaAward} title="Our Local Legends" image="https://images.unsplash.com/photo-1551632811-561732d1e306?q=80&w=2070&auto=format&fit=crop" description="Meet the certified experts who bring the stories of Gilgit-Baltistan to life."/>

            {/* Expertise Section */}
            <section className="py-20">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <SectionHeading badge="Certified Experts" title="Travel with the Best" description="Our guides are more than just navigators; they are storytellers, historians, and safety experts trained to deliver an unforgettable experience."/>

                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                        {guides.map((guide) => (<Link key={guide.id} href={`/guides/${guide.id}`} className="group relative">
                                {/* Guide Card */}
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="embla" ref={emblaRef}>
                        <div className="embla__container flex gap-4">
                            {expeditionImages.map((img, i) => (<div key={i} className="embla__slide flex-[0_0_85%] sm:flex-[0_0_45%] lg:flex-[0_0_30%] min-w-0">
                                    <div className="relative h-[400px] rounded-[2.5rem] overflow-hidden group shadow-lg">
                                        <Image src={img} className="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-110" alt="Expedition" width={1200} height={800}/>
        ...
        ].map((stat, i) => (<div key={i} className="text-center space-y-4">
